...
function updateView() {
  ...
  axios.put("".concat(Url, "/views/").concat(id), data).then(function (res) {
    Swal.fire({
      icon: "success",
      title: "編輯成功",
      showConfirmButton: false,
...
function getAdminEditData() {
  axios.get("".concat(Url, "/views/").concat(id)).then(function (res) {
    var data = res.data;
...
function getViewDetailData() {
  axios.get("".concat(Url, "/views")).then(function (res) {
    ...
    return axios.get("".concat(Url, "/user/").concat(userId, "/bookmarks?_expand=view"));
  }).then(function (res) {
    var data = res.data;
...
if (bookmarkAddBtn) {
  bookmarkAddBtn.addEventListener("click", function (e) {
    ...
    axios.post("".concat(Url, "/bookmarks"), data).then(function (res) {
      console.log(res.data);
    })["catch"](function (error) {
      console.log(error);
    });
...
function removeBookmark() {
  axios.get("".concat(Url, "/user/").concat(userId, "/bookmarks")).then(function (res) {
    console.log(res.data);
    var data = res.data;
    var thisId = 0;
    data.forEach(function (item) {
    ...
    return axios["delete"]("".concat(Url, "/bookmarks/").concat(thisId));
  }).then(function (res) {
    console.log(res.data);
  })["catch"](function (error) {
    console.log(error);
  ...
  if (bookmarkTag) {
    bookmarkTag.forEach(function (item) {
      item.addEventListener("click", function (e) {
        ...
        var id = e.target.dataset.id;
        console.log(id);
        axios["delete"]("".concat(Url, "/bookmarks/").concat(id)).then(function (res) {
          console.log(res.data);
          viewDetailInit();
        })["catch"](function (error) {
          console.log(error);
...
function getViewData() {
  axios.get("".concat(Url, "/views")).then(function (res) {
    var data = res.data;
    renderView(data);
    getViewId(); // renderViewDetail(data);
  })["catch"](function (error) {
    console.log(error);
  });
}
...
function login() {
  ...
  axios.post("".concat(Url, "/login"), data).then(function (res) {
    console.log(res.data);
